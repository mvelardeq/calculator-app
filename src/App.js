...
function App() {
  ...
  const onPressKey = ({ target }) => {
    ...
    if (
      isNaN(target.textContent) &&
      isNaN(calOperation.at(calOperation.length - 1))
    ) {
      return;
    }
    if (
      target.textContent === "." &&
      !getTheLastNumber(calOperation).includes(".")
    ) {
    ...
    if (target.textContent !== ".") {
      if (
        ...
        getTheLastNumber(calOperation) === "0"
      ) {
        return;
      ...
      <main className={`main ${theme}`}>
        <div className="calculatorContainer">
            ...
            <div className={`themeSection ${theme}`}>
              ...
              <div className={`actionTheme ${theme}`}>
                <div
                  ...
                  className={theme === "th1" ? "point show th1" : "point"}
                  id="pointTheme1"
                ></div>
                <div
                  onClick={onChangeTheme}
                  className={theme === "th2" ? "point show th2" : "point"}
                  id="pointTheme2"
                ></div>
                <div
                  onClick={onChangeTheme}
                  className={theme === "th3" ? "point show th3" : "point"}
                  id="pointTheme3"
                ></div>
              </div>
            </div>
          ...
          <div className={`keySection ${theme}`}>
            <div className={`key ${theme}`} onClick={onPressKey}>
              7
            </div>
            <div className={`key ${theme}`} onClick={onPressKey}>
              8
            ...
            <div className={`key del ${theme}`} onClick={onPressDelKey}>
              DEL
            </div>
            <div className={`key ${theme}`} onClick={onPressKey}>
              4
            ...
            <div className={`key reset ${theme}`} onClick={onPressResetKey}>
              RESET
            </div>
            <div className={`key equal ${theme}`} onClick={onPressEqualKey}>
              =
            </div>
          </div>
        </div>
